...
function tickFunc() {
	...
	switch(tick*0.01){
		...
		break;
		case 2: createPlatform('chao',25,3,0,20);createPers('moeda',2,3,0,45);
		break;
		case 3: createPers('pilar',2,2,0,15); break;
		case 4: createPers('moeda',2,3,0,15); break;
		...
		break;
		case 10.5: createPlatform('chao',300,3,0,20);
		createPers('pilar',2,2,0,30);
		break;
		case 11: createPers('pilar',2,2,0,35);
		break;
		case 11.5: createPlatform('chao',20,5,0,20); break;
		case 12: createPers('pilar',2,2,0,40);
		createPers('moeda',2,3,0,50);
		break;
		...
		case 15: createPers('moeda',2,3,0,70); break;
		case 15.5: createPlatform('chao',20,5,0,60); break;
		case 16: createPers('pilar',2,2,0,50);
		createPers('pilar',2,2,0,60);
		break;
		case 17: createPlatform('chao',50,5,0,20);
		createPers('moeda',2,3,0,60);
		break;
		case 18: createPers('pilar',2,2,0,50);
		createPers('pilar',2,2,0,60);
		break;
		case 19.5: createPers('pilar',2,2,0,60);
		createPers('pilar',2,2,0,20);
		break;
		case 20: createPlatform('chao',40,5,0,25);
		createPers('moeda',2,3,0,35); break;
		case 22: createPers('pilar',3,3,0,20); break;
		case 23: createPers('moeda',2,3,0,30); break;
		case 23.75: createPlatform('chao',20,3,0,35);
		case 24: createPers('pilar',4,4,0,25); break;
		case 25.25: createPers('moeda',2,3,0,40); break;
		case 25.75: createPers('moeda',2,3,0,25); break;
		case 26.25: createPers('pilar',4,4,0,25); break;
		case 27: createPers('pilar',2,2,0,25); break;
		case 27.25: createPers('moeda',2,3,0,25); break;
		case 27.50: createPers('pilar',2,2,0,25); break;
		case 28: createPlatform('final',30,35,0,50); break;
